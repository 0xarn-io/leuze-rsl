...
* :class:`UdtSimulator` -- pushes RSL-style **UDP data telegrams** (extended
  ...
  :class:`~pyrsl235.udt.RSL235Udt` receives.
* :class:`RSL235Simulator` -- implements the ROD-300-500 protocol (TCP
  ...
  :class:`~pyrsl235.driver.RSL235`.

Run standalone::

    python3 -m pyrsl235.simulator --port 3050            # UDT push mode
    python3 -m pyrsl235.simulator --rod --port 3050      # ROD protocol mode
...
log = logging.getLogger("pyrsl235.simulator")
