...
data telegrams) and assembles them into :class:`~pyrsl235.parser.Scan`
...
log = logging.getLogger("pyrsl235")
...
class RSL235:
    ...
    def connect(self, read_config: bool = True) -> "RSL235":
        ...
        self._tcp_thread = threading.Thread(
            target=self._tcp_rx_loop, name="pyrsl235-tcp-rx", daemon=True)
    ...
    def start_measurement(self, protocol_override: Optional[MdiProtocol] = None) -> None:
        ...
        if proto == MdiProtocol.UDP:
            ...
            self._udp_thread = threading.Thread(
                target=self._udp_rx_loop, name="pyrsl235-udp-rx", daemon=True)
